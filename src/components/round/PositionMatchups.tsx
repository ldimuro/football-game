...
function EmptySlot() {
  return (
    <div className="bg-gray-900 border border-dashed border-gray-700 rounded-xl p-4 flex items-center justify-center min-h-[8rem]">
...
export function PositionMatchups({ opponentTeam, opponentRoster, userRoster }: PositionMatchupsProps) {
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
      <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 text-center">Position Matchups</h3>
      <div className="grid grid-cols-2 text-center text-xs uppercase tracking-wider text-gray-500 mb-3">
      ...
      <div className="flex flex-col gap-6">
        {POSITIONS.map(pos => {
          ...
          return (
            <div key={pos}>
              <p className="text-xs font-bold text-indigo-400 uppercase tracking-wider text-center mb-2">{POSITION_LABELS[pos]}</p>
